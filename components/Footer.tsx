  ...
  return (
    <footer className="border-t border-[#22222F] bg-[#101015] mt-12">
      <div className="mx-auto max-w-7xl px-6 py-10 grid md:grid-cols-4 gap-8">
        <div><div className="flex items-center gap-2"><div className="h-8 w-8 rounded-lg bg-gradient-to-br from-[#7C3AED] to-[#06B6D4] flex items-center justify-center font-black text-[12px]">JB</div><span className="font-black text-[14px]">JOYBOY TOURNAMENTS</span></div><p className="mt-3 text-[12px] leading-relaxed text-zinc-500">La plateforme e-sport #1 en Côte d'Ivoire. Tournois 10 joueurs, 1V1 direct, vrai palmarès, gains Wave.</p><p className="mt-3 text-[11px] text-zinc-600">© 2025 JOYBOY TOURNAMENTS 🇨🇮</p></div>
