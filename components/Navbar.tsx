    ...
    >
      ...
      <div className="flex flex-col leading-none">
        <span className="text-[15px] font-black tracking-[-0.02em] text-white">
          JOYBOY{" "}
          <span className="bg-gradient-to-br from-[#A855F7] to-[#06B6D4] bg-clip-text text-transparent">
            TOURNAMENTS
          </span>
        </span>
...
export function Navbar() {
  ...
  const notificationBadge = formatNotificationCount(unreadCount);
      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/[0.06] bg-[#08080B]/80 backdrop-blur-[16px]">
        <div className="mx-auto flex h-[66px] max-w-[1280px] items-center justify-between px-4 lg:px-6">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Link
              href="/dashboard"
              className="flex items-center gap-2 rounded-full border border-[#22222F] bg-[#12121A] pl-1 pr-3 py-1 hover:border-[#7C3AED]/30 transition-colors"
            >
              <Avatar
                src={null}
                alt="Profil"
