...
export const metadata: Metadata = {
  ...
  description: "JOYBOY TOURNAMENTS - La première plateforme de tournois e-sport 100% ivoirienne. Défie les meilleurs joueurs d'Abidjan, participe aux tournois, gagne tes gains via Wave. Paiement Wave: 01 51 42 99 18 | WhatsApp: 07 48 23 52 26",
  openGraph: {
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="fr" className="dark" suppressHydrationWarning>
      <body className={`${inter.variable} ${space.variable} min-h-screen bg-[#08080B] font-sans text-white antialiased selection:bg-[#7C3AED]/30 selection:text-white`}>
        ...
        <Toaster position="top-right" richColors theme="dark" toastOptions={{ style: { background: "#15151E", border: "1px solid #22222F", color: "white" } }} />
      </body>
    </html>
  );
}
