...
import { E-TOURNOIS CI_CONFIG, submitPaymentProofLogic } from "@/lib/1v1/challengeLogic";
...
export default function PaymentPage() {
  ...
  const copyWave = async () => {
    await navigator.clipboard.writeText(E-TOURNOIS CI_CONFIG.wave);
    setCopied(true);
          ...
          <div className="space-y-5">
            <div className="rounded-[22px] border border-[#22222F] bg-[#15151E] p-6">
              ...
              <div className="mt-5 rounded-2xl bg-[#08080B] border border-[#22222F] p-4">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <div className="mt-1 text-2xl font-black tracking-wider font-mono text-white">{E-TOURNOIS CI_CONFIG.wave}</div>
                    <div className="text-xs text-zinc-500">Nom: {E-TOURNOIS CI_CONFIG.waveNom}</div>
                  </div>
                  <button
                    onClick={copyWave}
              ...
              <div className="mt-4 space-y-2 text-xs text-zinc-400 leading-relaxed">
                <p>• Ouvre Wave, envoie <span className="text-white font-semibold">500 FCFA</span> au <span className="text-white font-mono">{E-TOURNOIS CI_CONFIG.wave}</span></p>
              ...
              <div className="mt-5">
                {!preview ? (
                  <label className="group flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[#22222F] bg-[#08080B] py-10 px-4 cursor-pointer hover:border-[#7C3AED]/40 hover:bg-[#101015] transition">
                    ...
                    <div className="mt-1 text-xs text-zinc-500">PNG, JPG max 5 Mo • Le screen doit montrer 500 F, {E-TOURNOIS CI_CONFIG.wave}, et l'heure</div>
                ...
                {myPaid && (
                  <div className="mt-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 px-3 py-2.5 flex items-center gap-2 text-xs text-emerald-200">
                    <Check className="h-4 w-4 text-emerald-400" /> Ta preuve a bien été reçue, champion. En attente de l'adversaire et validation staff E-TOURNOIS CI.
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-[20px] border border-amber-500/20 bg-amber-500/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-[11px] leading-relaxed text-amber-100/70 list-disc list-inside">
                ...
                <li>Screen doit montrer : montant 500 F, numéro {E-TOURNOIS CI_CONFIG.wave}, heure et référence Wave.</li>
            ...
            <div className="rounded-[20px] border border-[#7C3AED]/20 bg-[#7C3AED]/5 p-5">
              ...
              <a href={E-TOURNOIS CI_CONFIG.whatsappLink} target="_blank" className="mt-3 flex w-full items-center justify-center gap-2 rounded-full bg-white text-black py-2.5 text-sm font-bold hover:bg-zinc-100 transition">
                <MessageCircle className="h-4 w-4" /> WhatsApp {E-TOURNOIS CI_CONFIG.whatsapp}
              </a>
