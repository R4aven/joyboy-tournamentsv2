...
import { STATUT_LABELS, formatMatchDate, ETOURNOIS_CI_CI_CONFIG, REGLEMENT_1V1_DEFAULT } from "@/lib/1v1/challengeLogic";
        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[20px] border border-[#22222F] bg-[#15151E] p-5">
              ...
              <p className="mt-3 text-xs text-zinc-500">Wave unique E-TOURNOIS CI: <span className="font-semibold text-white">{ETOURNOIS_CI_CI_CONFIG.wave}</span> - 500 FCFA chacun. Chaque joueur doit uploader sa preuve.</p>
              ...
              <div className="rounded-[20px] border border-[#22222F] bg-[#101015] p-5">
                ...
                {match.statut === "CONTESTE" && (
                  <div className="mt-4 rounded-xl border border-red-500/20 bg-red-500/10 p-3 flex gap-2 text-xs text-red-200/80">
                    ...
                    <div>{match.contestation_raison || "Déclarations différentes - contacte le staff sur WhatsApp"}<br /><a href={ETOURNOIS_CI_CI_CONFIG.whatsappLink} target="_blank" className="underline">WhatsApp {ETOURNOIS_CI_CI_CONFIG.whatsapp}</a></div>
                  </div>
                )}
              </div>
            )}
          ...
          <div className="space-y-4">
            <div className="rounded-[20px] border border-[#22222F] bg-[#15151E] p-5">
              ...
              <div className="mt-4 space-y-3 text-sm">
                ...
                <div className="flex justify-between"><span className="text-zinc-500">Wave</span><span className="text-white font-mono">{ETOURNOIS_CI_CI_CONFIG.wave}</span></div>
            ...
            <div className="rounded-[20px] border border-[#7C3AED]/20 bg-[#7C3AED]/5 p-5">
              ...
              <a href={ETOURNOIS_CI_CI_CONFIG.whatsappLink} target="_blank" className="mt-3 inline-flex w-full justify-center rounded-full bg-white text-black py-2.5 text-sm font-bold hover:bg-zinc-100 transition">WhatsApp {ETOURNOIS_CI_CI_CONFIG.whatsapp}</a>
