  ...
  return (
    <div className="min-h-screen bg-[#08080B] text-white p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-zinc-400 text-[13px] mt-2">E-TOURNOIS CI organise, tu joues sur eFootball puis reviens confirmer.</p>
        <div className="mt-6 space-y-3">
          <div className="rounded-[20px] border border-[#22222F] bg-[#101015] p-5">
            <p className="font-black">E-TOURNOIS CI CUP #12 vs Kev_225</p>
